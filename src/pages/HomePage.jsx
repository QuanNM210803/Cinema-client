...
import image4 from '~/assets/anh6.jpg'
import image5 from '~/assets/anh7.jpg'
import image6 from '~/assets/anh8.jpg'
			...
			<Box sx={{ alignItems:'center', height:'100vh', justifyContent:'center', display:'flex' }}>
				<Box sx={{ width:'100%', alignItems:'center', justifyContent:'center' }}>
					<Box sx={{ height:'100%', alignItems:'center', justifyContent:'center' }}>
						<SliderConponent arrImage={[image1, image2, image3, image4, image5, image6]}/>
					</Box>
				</Box>
			</Box>
