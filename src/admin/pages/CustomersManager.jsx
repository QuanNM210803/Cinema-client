...
function CustomersManager() {
	...
	const columns = [
		...
		{ field: 'numberOfTickets', headerName: 'Number Tickets', width: 150, editable: true },
		{ field: 'totalPayment', headerName: 'Total Payment', width: 170, editable: true, valueGetter: (params) => {
